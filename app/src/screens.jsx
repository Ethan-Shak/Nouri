...
import { LOOP_STEPS, LOOP_NARRATION, AUTONOMY_LEVELS, CONNECTORS, PLATFORMS } from './data.js'
import { FoodImage, PlatformCard } from './foodart.jsx'

/* ───────────────────────── Icons ───────────────────────── */
export const Icon = ({ k, size = 18, stroke = 'currentColor' }) => {
...
/* ─────────────────────── Brand mark ─────────────────────── */
export const BrandMark = ({ size = 22, color = 'var(--ink)', mono = false }) => (
...
/* ─────────────────────── Pill ─────────────────────── */
export const Pill = ({ children, tone = 'neutral', size = 'sm', style = {} }) => {
  const palette = {
...
/* ─────────────────────── Live loop hook ─────────────────────── */
export function useLoop(active) {
...
/* ─────────────────────── Loop indicator ─────────────────────── */
export const LoopRibbon = ({ stepIdx, compact = false }) => (
...
/* ───────────────────── NOW panel (the hero) ───────────────────── */
export const NowPanel = ({ persona, autonomy, hour, onTap, onApprove }) => {
...
/* ───────────────────── Timeline row ───────────────────── */
export const TimelineRow = ({ meal, onTap }) => {
...
export const MealSheet = ({ meal, persona, onClose, initialStage = 'review' }) => {
  if (!meal) return null
...
/* ─────────────────── Today screen ─────────────────── */
export const TodayScreen = ({ persona, autonomy, hour, userName, onOpenMeal, onApproveMeal }) => {
...
export const PersonaPill = ({ persona }) => (
  <div style={{
...
/* ─────────────────── Brain screen ─────────────────── */
export const BrainScreen = ({ persona }) => {
...
/* ─────────────────── Log screen ─────────────────── */
export const LogScreen = ({ persona, onOpenSpend }) => {
...
/* ─────────────────── Settings screen ─────────────────── */
export const SettingsScreen = ({ persona, autonomy, setAutonomy, onOpenAllergies }) => {
  return (
    <div style={{ padding: '0 18px 100px' }}>
...
export const AutonomyDial = ({ value, onChange }) => (
  <div>
...
/* ────────────── Sub-page shell ────────────── */
export const SubPage = ({ title, onBack, children, rightSlot }) => (
  <div style={{
    position: 'absolute', inset: 0,
...
export const AllergiesScreen = ({ onBack }) => {
...
export const AllergenGrid = ({ items, selected, onToggle }) => (
  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8 }}>
    {items.map(a => {
...
export const SpendDetailScreen = ({ onBack }) => {
